const translations = {
  en: {
    ...
    "docs.pane1.title": "Installation",
    "docs.pane1.p1": "Three steps to get ILC running on your Mac.",
    "docs.pane1.step1": "Download the .dmg file from the button above and save it to your Downloads folder.",
    "docs.pane1.step2": "Open the .dmg file and drag \"I Love Containers\" into your Applications folder.",
    "docs.pane1.step3": "macOS may block the app because it's not signed with an Apple Developer ID. Run this command in Terminal to allow it:",
  ...
  es: {
    ...
    "docs.nav.install": "Instalación",
    "docs.nav.files": "Gestión de Archivos",
    "docs.nav.multiwin": "Multi-Ventana",
    "docs.nav.shortcuts": "Atajos de Teclado",
    
    "docs.pane1.title": "Instalación",
    "docs.pane1.p1": "Tres pasos para tener ILC funcionando en tu Mac.",
    "docs.pane1.step1": "Descarga el archivo .dmg desde el botón de arriba y guárdalo en tu carpeta de Descargas.",
    "docs.pane1.step2": "Abre el .dmg y arrastra \"I Love Containers\" a tu carpeta de Aplicaciones.",
    "docs.pane1.step3": "macOS puede bloquear la app porque no está firmada con un Apple Developer ID. Ejecuta este comando en Terminal para permitirla:",
